...
v8::Handle<v8::Value> V8Ctx::ParseJson(const char *json) {
  ...
  */
  ...
  v8::Handle<v8::Value> json_parse_func = v8::Handle<v8::Object>::Cast(json_cls)->Get(
      v8::String::NewFromUtf8(isolate_, "parse"));
  v8::Handle<v8::String> v8_str =
      v8::String::NewFromUtf8(isolate_, json);
  v8::Handle<v8::Value> argv[1] = {v8_str};
  return v8::Handle<v8::Function>::Cast(json_parse_func)->Call(json_cls, 1, argv);
}
...
bool V8Ctx::GetValueBoolean(std::shared_ptr<CtxValue> value,
                            bool *result) {
  if (!value || !result) {
    return false;
  }
...
std::shared_ptr<CtxValue> V8Ctx::CopyNamedProperty(std::shared_ptr<CtxValue> value,
                                    const char *utf8name) {
  if (!value || !utf8name) {
    return nullptr;
  }
...
std::shared_ptr<CtxValue> V8Ctx::CallFunction(
  ...
  v8::MaybeLocal<v8::Value> maybe_result =
      v8_fn->Call(context, context->Global(),
                   static_cast<int>(argument_count), args);
