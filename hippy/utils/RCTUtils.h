...
// Create an NSError in the RCTErrorDomain
RCT_EXTERN NSError *RCTErrorWithMessageAndModule(NSString *message, NSString *moduleName);
...
RCT_EXTERN NSURL *__nullable RCTURLWithString(NSString *__nonnull URLString, NSString *__nullable baseURLString);

// get wheather current device memory bigger than 2GB
RCT_EXTERN BOOL RCTSystemMemoryGreaterThan2GBDevice(void);
