...
RCT_EXTERN void  MttRCTException(NSException *exception);
...
typedef void (^MttRCTExceptionHandler)(NSException *e);
...
RCT_EXTERN void MttRCTSetExceptionHandler(MttRCTExceptionHandler exceptionhandler);
RCT_EXTERN MttRCTExceptionHandler MttRCTGetExceptionHandler(void);
/**
