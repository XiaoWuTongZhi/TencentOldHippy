...
- (RCTVirtualNode *)createVirtualNode:(NSNumber *)tag props:(NSDictionary *)props
{
...
- (void)setProps:(NSDictionary<NSString *, id> *)props forView:(id<RCTComponent>)view
{
    ...
    [props enumerateKeysAndObjectsUsingBlock:^(NSString *key, id json, __unused BOOL *stop) {
        RCTPropBlock block = [self propBlockForKey:key inDictionary:self->_viewPropBlocks];
        block(view, json);
    }];
...
- (void)setProps:(NSDictionary<NSString *, id> *)props forShadowView:(RCTShadowView *)shadowView
{
    ...
    [props enumerateKeysAndObjectsUsingBlock:^(NSString *key, id json, __unused BOOL *stop) {
        RCTPropBlock proBlock = [self propBlockForKey:key inDictionary:self->_shadowPropBlocks];
        proBlock(shadowView, json);
    }];
