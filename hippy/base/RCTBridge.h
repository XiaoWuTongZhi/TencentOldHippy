...
#import "RCTCustomTouchHandlerProtocol.h"
...
@class RCTUIManager;
@class RCTExtAnimationModule;
extern NSString *const _RCTSDKVersion;
/**
...
// MttRN: 业务代码已经成功加载的通知
RCT_EXTERN NSString *const RCTBusinessDidLoadNotification;
...
@property (nonatomic, weak, readonly) RCTExtAnimationModule *animationModule;

@property (nonatomic, strong, readonly) id <RCTImageViewCustomLoader> imageLoader;
@property (nonatomic, strong, readonly) id <RCTCustomTouchHandlerProtocol> customTouchHandler;
@property (nonatomic, strong, readonly) NSSet<Class<RCTImageProviderProtocol>> *imageProviders;
