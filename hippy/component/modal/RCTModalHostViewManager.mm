...
@interface RCTModalHostViewManager () 
...
- (id<RCTModalHostViewInteractor, UIViewControllerTransitioningDelegate>)transitioningDelegate {
    if (!_transitioningDelegate) {
        _transitioningDelegate = [RCTModalTransitioningDelegate new];
    }
...
RCT_EXPORT_VIEW_PROPERTY(darkStatusBarText, BOOL)
RCT_EXPORT_VIEW_PROPERTY(onShow, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onRequestClose, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(supportedOrientations, NSArray)
RCT_EXPORT_VIEW_PROPERTY(onOrientationChange, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(primaryKey, NSString)
RCT_EXPORT_VIEW_PROPERTY(hideStatusBar, NSNumber)
@end
