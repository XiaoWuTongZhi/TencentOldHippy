...
- (void)drawRect:(__unused CGRect)rect
{
  ...
  [layoutManager.textStorage enumerateAttribute:RCTIsHighlightedAttributeName inRange:characterRange options:0 usingBlock:^(NSNumber *value, NSRange range, __unused BOOL *_) {
    if (!value.boolValue) {
      return;
    }
...
- (void)setBackgroundImageUrl:(NSString *)backgroundImageUrl {
    RCTLogWarn(@"Warning:    backgroundImage is not available in RCTText.");
}
