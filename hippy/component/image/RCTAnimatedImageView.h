...
//
//  An `RCTAnimatedImageView` can take an `RCTAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface RCTAnimatedImageView : UIImageView
...
@property (nonatomic, strong) RCTAnimatedImage *animatedImage;
