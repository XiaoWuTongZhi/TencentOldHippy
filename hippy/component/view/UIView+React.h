...
#import "RCTViewEventProtocol.h"

@class RCTShadowView;
@class RCTVirtualNode;

@interface UIView (React) <RCTComponent, RCTViewEventProtocol, RCTViewTouchHandlerProtocol>
...
/**
 * RCTViewTouchHandlerProtocol interface.
 */
 ...
 *
 */
- (void)didUpdateWithNode:(RCTVirtualNode *)node;
